...
BEGIN
    SELECT MAX(UNITPRICE) INTO MOSTEXPTRACK FROM TRACK T1;
    RETURN MOSTEXPTRACK;
END;
/
BEGIN
...
--RETURN VARCHAR IS EMPLOYEENAME VARCHAR(20); 
--BEGIN
--    SELECT EMPLOYEE.FIRSTNAME FROM EMPLOYEE WHERE EMPLOYEE.BIRTHDAY > TO_DATE('1986','yyyy');
--END;
