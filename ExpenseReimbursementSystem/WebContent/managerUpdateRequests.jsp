...
<head>
<title>Manager Update Requests - ERS</title>
...
<h1><center>Manager Update Requests</center></h1>
<h3><center>Approve/Deny Pending Requests</center></h3>
<!-- <div style="color:white;margin:60px;font-family:'Lato',sans-serif;"> -->

<!-- <center><button type="submit" class="btn btn-primary" id="viewAll" onclick="loaddata();">View Pending Requests</button></center> -->
<div id="display_info" >
</div>  
...
window.onload = function() {
	  $.ajax({
		  type: 'post',
		  url: 'http://localhost:8080/ExpenseReimbursementSystem/ManagerUpdateRequestsServlet',
		  data: {
		  },
