...
public class ReimbursementHome extends HttpServlet {

	public ReimbursementHome() {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		for(ReimbursementTicket rt : tickets){
			...
			//pw.println("<td><a href='viewImage' name='imgId' value='"+rt.getR_id()+"'>Receipt</a></td>");
		...
		pw.println("</table>");
		pw.println("</div>");
		req.getRequestDispatcher("load/goToCreateRT.html").include(req, resp);
		//pw.println("<script type='text/javascript'> window.onload = printMyReim() </script>");
		//req.getRequestDispatcher("load/goToChangeInfo.html").include(req, resp);
