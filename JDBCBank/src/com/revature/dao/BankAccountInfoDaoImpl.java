...
public class BankAccountInfoDaoImpl implements BankAccountInfoDao{

	@Override
	public List<BankAccountInfo> getBankAccountList(int userId) {
		List<BankAccountInfo> bai = new ArrayList<>();
		...
		try{
			...
			while (rs.next()) {
				...
				bai.add(new BankAccountInfo(id, bankAccountId));
			}
	...
	public int getBankAccountBalance(int userId, int bankAccountId) {
		...
		BankAccountInfoDaoImpl baidi = new BankAccountInfoDaoImpl();
//		Bear bear = null;
