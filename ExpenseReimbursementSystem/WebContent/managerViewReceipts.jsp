...
<head>
<title>Manager View Receipts - ERS</title>
...
<h1><center>View Receipts</center></h1>
<div style="color:white;margin:60px;font-family:'Lato',sans-serif;"></div>  
...
window.onload = function() {
	  $.ajax({
		  type: 'post',
		  url: 'http://localhost:8080/ExpenseReimbursementSystem/ManagerViewReceiptsServlet',
		  data: {
		  },
