...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(sc.checkUpperCase("zAid"));
		System.out.println(sc.checkUpperCase("midi"));
		
		System.out.println(sc.toUpperCase("red"));
		
		System.out.println(sc.toIntPlus10("90"));
