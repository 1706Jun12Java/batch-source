...
import com.ers.domain.ReimbursementModel;
...
public interface ReimbursementDao {
	...
	public boolean submitReimbursementRequest(BigDecimal rAmount, String rDescription, InputStream fileContent, Timestamp rSubmitted, int uIdAuthor, int rtType); 
